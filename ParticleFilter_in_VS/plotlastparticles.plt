...
reset
cd "./graph/lastparticles"
set terminal pdf
do for[j=0:99]{
	set output sprintf("lastparticles-%d.pdf",j)
	plot "../../result_last_particle.dat" ind j u 1:2 smooth unique w linespoints pt 7 ps 1 t sprintf("lastparticles%d",j)
	set output
}
